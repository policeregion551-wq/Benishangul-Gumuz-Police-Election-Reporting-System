          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="glass-card p-6">
                 <h3 className="text-sm font-bold text-neutral-400 uppercase tracking-widest mb-4">የሲስተም መረጃ (System Info)</h3>
                 <div className="space-y-3">
                   ...
                   <div className="p-3 bg-white/5 rounded-lg border border-white/5">
                     <p className="text-[10px] text-neutral-500 uppercase font-black mb-1">Database ID</p>
                     <p className="text-xs font-mono text-gold truncate">{config.firestoreDatabaseId || "(default)"}</p>
                   </div>
                   <p className="text-[10px] text-neutral-500 italic mt-2">
                     * በፋየርቤዝ ኮንሶል ላይ ዳታውን ለማየት ከላይ ያለውን Database ID መምረጥዎን ያረጋግጡ::
                   </p>
                 </div>
              </div>
